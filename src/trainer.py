...
def train_and_fit(args):
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        if accuracy_per_epoch[-1] > best_pred:
            ...
            torch.save({
                ...
                }, os.path.join(args.temp_folder_path , "test_model_best_%d.pth.tar" % args.model_no))
        ...
        if (epoch % 1) == 0:
            ...
            torch.save({
                    ...
                    'scheduler' : scheduler.state_dict(),\
                    'amp': amp.state_dict() if amp is not None else amp
                }, os.path.join(args.temp_folder_path , "test_checkpoint_%d.pth.tar" % args.model_no))
    ...
    plt.savefig(os.path.join(args.temp_folder_path ,"loss_vs_epoch_%d.png" % args.model_no))
    ...
    plt.savefig(os.path.join(args.temp_folder_path ,"accuracy_vs_epoch_%d.png" % args.model_no))
